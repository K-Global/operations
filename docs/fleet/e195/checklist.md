<!--
================================================================================
  K Global — AIRFRAME PACK · CHECKLIST  ·  E195 Embraer 195
...
# E195 — Embraer 195 · Normal Checklist
...
- Landing perf / VREF / flap setting …… CHECKED, SET — note slightly longer field-length requirement than the E190 (Dispatch §6) 🟧
...
- X-Crafts — Embraer E195 (systems scope, X-Plane.Org Store) — https://store.x-plane.org/Embraer-E195-by-X-Crafts_p_1729.html

## Change Log
| Version | Date | Change |
|---|---|---|
| v0.1 | 2026-07-25 | Initial draft — generic E-Jet (E1/CF34-10E) EICAS/electronic-checklist normal flow re-expressed, mirrored from the common-rated E190 Checklist with the stretched-airframe field-length note added; Before-takeoff/Landing marked 🟥; model-dependent items 🟧 |
