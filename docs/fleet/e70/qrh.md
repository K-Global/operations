<!--
================================================================================
  K Global — AIRFRAME PACK · QRH  ·  E70 Embraer E170
...
# E70 — Embraer E170 · QRH

**E70 / E-Jet family — common type rating E170/E175** · flown as X-Crafts E170 🟧 `[VERIFY — model]` · sim = X-Plane 11
...
*Memory-item modelling 🟧: engine fire/discharge, air-data faults and depressurisation are represented with reasonable depth on the X-Crafts E170; verify each triggers before training to it.*
...
- **Driftdown / one-engine-inop ceiling:** on engine loss, follow driftdown to the OEI ceiling. The E70's short-haul regional network sits inside the 60-minute diversion standard, so no EDTO critical-fuel check applies (Dispatch §5) — this differs from K Global's EDTO-backbone widebody types.
...
| Version | Date | Change |
|---|---|---|
| v0.1 | 2026-07-25 | Initial draft — chaptered E-Jet EICAS abnormal/emergency reference re-expressed for the E170; memory items 🟥 (unreliable airspeed, emergency descent, engine fire, evacuation, stall); figures `[VERIFY]`; consistent with the common E170/E175 type-rating pair. |
