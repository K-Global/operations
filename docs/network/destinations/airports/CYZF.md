...
| Control type | **Procedural / Mandatory Frequency (MF)** outside tower hours (Tower 14–05Z ≈ 07:00–22:00 local); Edmonton Centre (procedural, non-radar FIR per ) otherwise — no dedicated radar Approach identified |
...
- CFS data is from the **21 MAR 2024–16 MAY 2024 AIRAC cycle** — re-verify against current AIRAC before relying on any frequency/procedure name.
...
|---|---|---|---|---|---|---|---|
| 16/34 | 7,503 × 150 ft (2,287 × 46 m) | Asphalt / PCN not published | Not published / verify | Not published / verify | Not published / verify | Not published / verify | BAK-12 arresting cable — NOTAM when raised; RVR-certified 1,200 ft (¼ SM) both ends |
| 10/28 | 5,001 × 150 ft (1,524 × 46 m) | Asphalt / PCN not published | Not published / verify | Not published / verify | Not published / verify | Not published / verify | Rough pavement ~2,400–2,495 ft beyond THR 10, 39 ft N of centreline; used as taxiway during RVOP |

*No numeric TORA/TODA/ASDA/LDA table was reached — CFS source cites physical runway length/width and certification data only. No displaced threshold identified on either runway. Verify all declared distances and PCN against the current AIP Canada AD 2 CYZF page before operational use.*
...
| Centre / FIR | Edmonton Centre | 135.8 (PAL) | H24 | Edmonton ACC (IFR) 888-358-7526; Edmonton FIC 866-WXBRIEF |
...
- **Wide-body / long-body types (OM B):** RWY 34 (7,503 ft / 2,287 m) is length-adequate at this sea-level-equivalent elevation for most alternate-landing weights, but **RFF CAT 6 may not meet the required category** for larger fleet types — confirm against each type's OM B category requirement before filing CYZF as a planned (vs. contingency-only) alternate for those types.
...
- **General:** Cold-soak fuel and cold-start procedures per OM B apply to any type staged or diverted here outside the short sub-Arctic summer.
...
- NAV CANADA AIP Canada (ENR) + "Magnetic to True North" briefing — NDA/standard-pressure-region and True-track context (full detail in ) — https://www.navcanada.ca/en/enreng22-january-2026.pdf (retrieved 2026-06-26, per ).
