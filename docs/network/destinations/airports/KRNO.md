...
|---|---|---|---|---|---|---|---|
| 17R | 11,001 × 150 ft | Concrete/grooved · 917/R/B/W/T | 11,001 | 11,001 | 11,001 | 10,001 | Displaced thr 1,000 ft (SkyVector) / 999 ft (OurAirports) — minor source discrepancy . MALSR, PAPI 3.06°. |
...
*From FAA data mirrored via SkyVector/AirNav (retrieved 2026-07-25). Exact ATIS/Approach hour windows not published in the sources checked — flag .*
...
| ILS/LOC | — RWY 35L | Not published / verify | — | **OFP NOTAM: DME U/S.** Name only — see §10. |
| ILS/LOC | — RWY 17R (3 variants: X/Y/Z) | Not published / verify | — | Name only — see §10. |
...
*ILS localizer/DME frequencies not confirmed from the public sources checked — governance requires names-only citation for procedures in any case; verify all navaid frequencies on the current-AIRAC chart before use.*
...
| RWY | Approach | Notes |
|---|---|---|
| 35L | ILS OR LOC RWY 35L | **DME reported U/S per OFP NOTAM** — confirm current status |
...
| 17R | ILS X OR LOC X RWY 17R | |
| 17R | ILS Z OR LOC Z RWY 17R | |
| 17R | ILS Y RWY 17R | |
...
> **Pull at planning (T-2h).** Perishable — not stored here. Check specifically: **ILS RWY 35L DME status** and **FMG TACAN AZM status** (both reported U/S on the OFP at last review), other navaid/runway/taxiway closures, lighting, obstacle/crane, RFF status, GPS/RAIM for RNP operations, and current SID/STAR validity. Source: official AIS / SimBrief OFP NOTAM block.
...
- FAA airport facility data for KRNO (cycle 2606, eff. 2026-06-11) — AirNav — https://www.airnav.com/airport/KRNO (retrieved 2026-07-25).
