...
| Customs | Customs Landing Rights Airport / PoE since 2006-10-05; specific hours not confirmed | |
...
| ILS/LOC | — | Not published / verify | — | Serves RWY 17L (+SA CAT II), 17R (+SA CAT I/CAT II-III), 35L — **ident/frequency not captured in reachable source** |

*Navaid table from AirNav/SkyVector FAA-data mirrors, cycle eff. 11 Jun 2026. ILS localizer idents/frequencies were referenced only as chart PDFs, not extracted as text this session — pull from current AIRAC before ops.*
...
| RWY | Approach | Notes |
|---|---|---|
| 17L | ILS or LOC, ILS (SA CAT II), RNAV (RNP) Z, RNAV (GPS) Y | |
| 17R | ILS or LOC, ILS (SA CAT I), ILS (CAT II-III), RNAV (RNP) Z, RNAV (GPS) Y | CAT II/III runway |
| 35L | ILS or LOC, RNAV (RNP) Z, RNAV (GPS) Y | |
...
- FAA AIP, Part 3 AD 2.0 California — https://www.faa.gov/air_traffic/publications/atpubs/aip_html/part3_ad_2.0_california.html — attempted, page did not return extractable text this session; **primary verification pending** at next update.
- U.S. CBP — Sacramento International Airport (KSMF) General Aviation Fact Sheet — https://www.cbp.gov/document/general-aviation/sacramento-international-airport-ksmf-fact-sheet-details — attempted, page did not return content this session; **customs hours verification pending**.
