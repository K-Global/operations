---
title: North America destinations
---
...
| Turks and Caicos Islands | `MBPV` | PLS | Providenciales Intl |
| U.S. Virgin Islands | `TIST` | STT | Cyril E King |
| U.S. Virgin Islands | `TISX` | STX | Henry E Rohlsen |
| United States | `KATL` | ATL | Hartsfield-Jackson Atlanta Int |
| United States | `KBOS` | BOS | Logan Intl |
| United States | `KEWR` | EWR | Newark Liberty Intl |
| United States | `KIAD` | IAD | Washington Dulles Intl |
| United States | `KIAH` | IAH | George Bush Intcntl-Houston |
