...
| Field | Value |
|---|---|
| Usual departure runway(s) | Single runway 09/27 — wind-based end selection only |
...
- **By wind / config:** Single runway (09/27) — wind determines the active end only.
...
- **Close-in / distant obstacles:** No terrain of note — flat Sahel coastal-plain field (see [Briefing §3.1](index.md)).
...
- **Clearance delivery:** Not published / verify — no dedicated Delivery/Ground/Approach frequency found; cross-ref [Briefing §8](index.md).
- **Frequency sequence:** Tower (118.550) is the only confirmed ATS frequency at tier-4 besides ATIS (136.300); expect Tower to combine ground/approach duties at a field this size — not independently confirmed.
...
- **Field-length / weight:** Non-limiting — 3,300 m, unusually wide (60 m) single runway for K Global's Cat S–assigned types.
- **Density altitude / temperature:** Sea-level field (21 ft) — not hot-and-high; note pronounced summer heat at this Tunisian Sahel latitude as a general performance-margin consideration in peak season.
...
- **Link to OM B:** No type-specific consideration identified at this field length/elevation. See [`OM B — Fleet Capability Matrix`](../../../../../fleet/capability-matrix.md).

---

## 10. Gotchas

- **Single-runway field** — no reciprocal-pair or crossing-runway options; confirm the active end from current wind/ATIS.
- **No on-field navaid confirmed** (see [Briefing §9](index.md)) — this is primarily an arrival-side concern but is worth carrying into departure planning if an immediate-return/diversion scenario arises.
...
- Ground/Approach frequency (not found at tier-4).
...
- OurAirports — https://ourairports.com/airports/DTNH/ , /runways.html , /frequencies.html (retrieved 2026-07-26). *Runway geometry and tier-4 frequency baseline.*
