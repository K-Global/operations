---
title: EUR-SAM Corridor (airspace)
---

<span class="kg-eyebrow">OM C · Airspace</span>

# EUR-SAM Corridor — airspace brief
...
|---|---|---|---|---|
| Amílcar Cabral, Sal | **GVAC** | African / mid-ocean | **ETP-pair field**, primary African-side ETOPS alternate | Long runway, H24, corridor gateway. **Brief exists** —  |
...
- Companion OM C airport briefs:  (+ SBFZ/SBGR/SBKP to build). Sister sector: .
